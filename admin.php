							...
							<div class="row">
								<div class="col-xs-12">
									<div class="section__inner">
										<h1 class="ui-title-page">Siparişler</h1>
										<ol class="breadcrumb">
								...
								<div class="col-md-8">
                                 ...
                                 <div class="table-container">
										<table class="table table-cart-order">
											...
											<tbody>
                                              <?php  $sorgu=mysql_query("SELECT * FROM siparisler order by siparis_id desc");
while($kayit=mysql_fetch_array($sorgu)){ ?>
												<tr>
												<td class=""><span class="table-cart-order__number"><?php echo $kayit["siparis_id"]; ?></span></td>
													<td class="">
														...
														<span class="table-cart-order__size"><b>Ayrıntılar:</b><?php echo $kayit["siparis_sepeti"]; ?></span><br>
                                                        <span class="table-cart-order__size"><b>Adres:</b><?php echo $kayit["siparis_musteri_adres"]; ?></span><br>
                                                         <span class="table-cart-order__size"><b>Telefon:</b><?php echo $kayit["siparis_musteri_telefon"]; ?></span>
													</td>
													...
													<td class=""><span class="table-cart-order__size"><?php echo $kayit["siparis_tarihi"]; ?></span></td>
													      		<td class=""><span class="table-cart-order__size"><a href="siparissil.php?urun_id=<?php echo $kayit["siparis_id"];  ?>"><img width="50px" height="50px" src="images/Delete.png"/></a></span></td>
												</tr>
												<?php } ?>
											</tbody>
										</table>
