							...
							<div class="row">
								<div class="col-xs-12">
									<div class="section__inner">
										<h1 class="ui-title-page">Yönetici Listesi</h1>
										<ol class="breadcrumb">
								...
								<div class="col-md-8">
                                 ...
                                 <div class="table-container">
										<table class="table table-cart-order">
											...
											<tbody>
                                              <?php  $sorgu=mysql_query("SELECT * FROM uyeler where uye_onay=1 order by uye_id desc");
while($kayit=mysql_fetch_array($sorgu)){ ?>
												<tr>
												<td class=""><span class="table-cart-order__number"><?php echo $kayit["uye_id"]; ?></span></td>
                                               <td class="">
                                               <span class="no-br">
                                               <div class="sinifim"> 
                                              <img class="table-cart-order__img img-responsive" src="<?php if($kayit["uye_pf"]){echo $kayit["uye_pf"];}else{ ?>images/profilepic.png<?php } ?>" height="109" width="109" alt="Foto"/></div>
                                               </span>
                                               </td>
													
													<td class="">
														<span class="table-cart-order__name"><?php echo $kayit["uye_adi"]." ".$kayit["uye_soyadi"]; ?></span>	
                                                        <span class="table-cart-order__size"><b>Adres:</b><?php echo $kayit["uye_adres"]; ?></span><br>
                                                         <span class="table-cart-order__size"><b>İlçe/İl:</b><?php echo $kayit["uye_il_ilce"]; ?></span><br>
                                                       <span class="table-cart-order__size"><b>EPosta:</b><?php echo $kayit["uye_mail"]; ?></span><br>
                                                        <span class="table-cart-order__size"><b>Telefon:</b><?php echo $kayit["uye_telefon"]; ?></span>
													</td>
													
													<td class=""><span class="table-cart-order__size"><a href="adminyap.php?uye_id=<?php echo $kayit["uye_id"];  ?>"><img width="50px" height="50px" src="images/greenTick.png"/></a></span></td>
														<td class=""><span class="table-cart-order__size"><a href="uyesil.php?uye_id=<?php echo $kayit["uye_id"];  ?>"><img width="50px" height="50px" src="images/Delete.png"/></a></span></td>
												</tr>
												<?php } ?>
											</tbody>
										</table>
