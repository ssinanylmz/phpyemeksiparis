				...
				<div class="wrap-content">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="section__inner">
										<h1 class="ui-title-page">Arama Sonuçları</h1>
										<ol class="breadcrumb">
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="filter clearfix">
									<span class="filter__btn" data-toggle="collapse" data-target="#filter-categories"><i class="icon fa fa-bars"></i>Arama Sonucları</span>
					...
					<div class="section-catalog">
						<div class="container">
							...
							$sorgu1=mysql_query("SELECT * FROM urunler where urun_adi like '%$keyword%' or urun_aciklama like '%$keyword%'");
							$kayit1=mysql_fetch_array($sorgu1);
							if(!$kayit1){ ?> <div class="label-danger">Üzgünüz aradığınız kriterlerde ürün bulunamadı..!!!</div> <?php }
							
							
$sorgu=mysql_query("SELECT * FROM urunler where urun_adi like '%$keyword%' or urun_aciklama like '%$keyword%'");
