...
<!-- Mirrored from html.templines.com/margherita/shop-catalog-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 May 2016 15:49:07 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
		<meta charset="utf-8">
		<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimal-ui">
		<title>Marherita, Pizza Menu</title>
				...
				<div class="wrap-content">
					...
					<header class="header clearfix">
						<div class="header__wrap">
							...
							<a class="logo" href="index.php"><img class="img-responsive" src="images/logo_mod-a.png" alt="Logo"></a>
							<span class="header-basket sb-toggle-right"><i class="icon pe-7s-cart"></i><span class="header-basket__number">  <?php @session_start(); echo  @$_SESSION["sepetsayac"];  ?></span></span>
						</div>
					</header>
					<!-- end header -->
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="section__inner">
										<h1 class="ui-title-page">Margherita Pizza</h1>
										<ol class="breadcrumb">
									
											<li class="active">Eşsiz Lezzet</li>
										</ol>
									</div>
									<!-- end section__inner -->
								</div>
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="filter clearfix">
									<span class="filter__btn" data-toggle="collapse" data-target="#filter-categories"><i class="icon fa fa-bars"></i>Özel Menüler</span>
								<span class="filter__info"></span></div>
								<!-- end filter -->
						...
						<div class="container">
							<div class="row">
								<div class="col-xs-12">
                                  ...
                                  <?php  $sorgu=mysql_query("SELECT * FROM urunler WHERE urun_kategori_id=4 limit 0,4");
while($kayit=mysql_fetch_array($sorgu)){ ?>
										<div class="pizza-builder__item pizza-builder__item_mod-b" tabindex="1">
											<div class="pizza-builder__check-img pizza-builder__check-img pizza-builder__check-img_mod-a">
												<img class="img-responsive center-block" src="<?php echo $kayit["urun_pic"]; ?>" height="258" width="258" alt="Foto">
											</div>
											<div class="pizza-builder__check-name"><?php echo $kayit["urun_adi"]; ?></div>
											<div class="pizza-builder__check-description pizza-builder__check-description_mod-a"><?php echo $kayit["urun_aciklama"]; ?></div>
											<div class="pizza-builder__check-price pizza-builder__check-price_mod-a"><?php echo $kayit["urun_fiyat"]; ?>.00₺</div>
										
											<a class="pizza-builder__btn-select ui-btn ui-btn-primary btn-effect" href="?urun_id=<?php echo $kayit["urun_id"]; ?>">Ekle</a>
										</div>
...
<div class="filter clearfix">
									<span class="filter__btn" data-toggle="collapse" data-target="#filter-categories"><i class="icon fa fa-bars"></i>Kampanyalı Pizzalar</span>
									<span class="filter__info"></span>
									<span class="filter__wrap-select">
												<div >Daha Fazlası için <a class="checkout-top-line__link" href="pizzalar.php">Tıklayınız</a></div>
									</span>
								</div>
                                  <?php  $sorgu=mysql_query("SELECT * FROM urunler WHERE urun_kategori_id=1 limit 0,4");
while($kayit=mysql_fetch_array($sorgu)){ ?>
...
<div class="pizza-builder__item pizza-builder__item_mod-b" tabindex="1">
											...
											<div class="pizza-builder__check-name"><?php echo $kayit["urun_adi"]; ?></div>
											<div class="pizza-builder__check-description pizza-builder__check-description_mod-a"><?php echo $kayit["urun_aciklama"]; ?></div>
											<div class="pizza-builder__check-price pizza-builder__check-price_mod-a"><?php echo $kayit["urun_fiyat"]; ?>.00₺</div>	<a class="pizza-builder__btn-select ui-btn ui-btn-primary btn-effect" href="?urun_id=<?php echo $kayit["urun_id"]; ?>">Ekle</a>
										</div>
<?php } ?>
...
<div class="filter clearfix">
									<span class="filter__btn" data-toggle="collapse" data-target="#filter-categories"><i class="icon fa fa-bars"></i>Kampanyalı Tatlılar</span>
									<span class="filter__info"></span>
									<span class="filter__wrap-select">
												<div >Daha Fazlası için <a class="checkout-top-line__link" href="tatlilar.php">Tıklayınız</a></div>
									</span>
								</div>
										  <?php  $sorgu=mysql_query("SELECT * FROM urunler WHERE urun_kategori_id=2 limit 0,4");
while($kayit=mysql_fetch_array($sorgu)){ ?>
...
<div class="section-carusel wow fadeInRight" data-wow-duration="2s">
						<div class="carusel slider_mod-c owl-carousel owl-theme enable-owl-carousel"
							...
							<a href="images/carusel_1.jpg" class="prettyPhoto"><img class="img-responsive" src="images/carusel_1.jpg" height="280" width="280" alt="Foto"></a>
							<a href="images/carusel_2.jpg" class="prettyPhoto"><img class="img-responsive" src="images/carusel_2.jpg" height="280" width="280" alt="Foto"></a>
							<a href="images/carusel_3.jpg" class="prettyPhoto"><img class="img-responsive" src="images/carusel_3.jpg" height="280" width="280" alt="Foto"></a>
							<a href="images/carusel_4.jpg" class="prettyPhoto"><img class="img-responsive" src="images/carusel_4.jpg" height="280" width="280" alt="Foto"></a>
							<a href="images/carusel_5.jpg" class="prettyPhoto"><img class="img-responsive" src="images/carusel_5.jpg" height="280" width="280" alt="Foto"></a>
							<a href="images/carusel_6.jpg" class="prettyPhoto"><img class="img-responsive" src="images/carusel_6.jpg" height="280" width="280" alt="Foto"></a>
							<a href="images/carusel_7.jpg" class="prettyPhoto"><img class="img-responsive" src="images/carusel_7.jpg" height="280" width="280" alt="Foto"></a>
							<a href="images/carusel_3.jpg" class="prettyPhoto"><img class="img-responsive" src="images/carusel_3.jpg" height="280" width="280" alt="Foto"></a>
							<a href="images/carusel_4.jpg" class="prettyPhoto"><img class="img-responsive" src="images/carusel_4.jpg" height="280" width="280" alt="Foto"></a>
						</div>
						<!-- end carusel -->
						...
						<div class="container">
							<div class="row">
								<div class="col-xs-12">
									<div class="carusel-nav">Bizi Takip edin instagram   <i class="icon fa fa-arrow-circle-o-right"></i> <a class="no-br" href="javascript:void(0);"># margherita pizza</a></div>
								</div>
							</div>
						</div>
						<!-- end container -->
...
<!-- Mirrored from html.templines.com/margherita/shop-catalog-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 May 2016 15:50:53 GMT -->
</html>
