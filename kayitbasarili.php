...
<head>
  ...
  <meta http-equiv="refresh" content="3; url=http://localhost/YemekSiparis/login.php" />
			...
			<div id="sb-site">
				...
				<div class="wrap-content">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="section__inner">
										<h1 class="ui-title-page">Kayıt Basarılı</h1>
										<ol class="breadcrumb">
											<li><a href="index.php">Anasayfa</a></li>
											<li class="active">Kayıt Başarılı</li>
										</ol>
									</div>
									<!-- end section__inner -->
								</div>
					...
					<section class="section-subscribe">
						<form class="form-subscribe" action="login.php">
							<div class="container">
								<div class="row">
									<div class="col-xs-12">
									  <h2 class="ui-title-block ui-title-block_mod-a form-subscribe__title">Giriş Sayfasına Yönlendiriliyorsunuz Lütfen Bekleyiniz....</h2>
									
										<button class="ui-btn ui-btn_mod-c btn-effect btn-effect">Beklemek İstemiyorsanız Tıklayın..GİRİŞ YAP</button>
									</div>
									<!-- end col -->
								</div>
								<!-- end row -->
