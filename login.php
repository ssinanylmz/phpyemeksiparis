			...
			<div id="sb-site">
				...
				<div class="wrap-content">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="section__inner">
										<h1 class="ui-title-page">Giriş Yap</h1>
										<ol class="breadcrumb">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8">
								<div class="checkout-top-line">Üyeliğiniz Yok mu ?    <a class="checkout-top-line__link" href="register.php">Hemen Kaydolmak için tıklayın...</a></div>
							</div>
							<!-- end col -->
					...
					<div class="section_mod-f">
						<div class="container">
							<div class="row">
								<div class="col-md-8">
									<form method="post" action="loginfinish.php" class="form-details">
										<section class="section-area">
											<h2 class="ui-title-inner ui-title-inner_mod-a">Giriş Yap</h2>
											
											<div class="row">
												<div class="col-md-6">
													<label class="ui-form-label">E-POSTA</label>
													<input name="giris_Eposta" class="form-control" type="text">
												</div>
												<div class="col-md-6">
													<label class="ui-form-label">ŞİFRE</label>
													<input name="giris_sifre" type="password" class="form-control" type="text">
												</div>
                                                
                                                    <button style="width:100%" type="submit" name="GirisYap" class="form-payment__btn ui-btn ui-btn-primary btn-effect" id="GirisYap">GİRİŞ YAP</button>
                                                    <?php @session_start();  echo @$_SESSION["Hata"]; @$_SESSION["Hata"]=""; ?>
											</div>
