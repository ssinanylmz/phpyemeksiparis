						...
						<div class="row">
							<div class="col-xs-12">
								<div class="filter clearfix">
									<span class="filter__btn" data-toggle="collapse" data-target="#filter-categories"><i class="icon fa fa-bars"></i>pizza ÇeŞİtlerİ</span>
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="pizza-builder__wrap-check">
										                          <?php  $sorgu=mysql_query("SELECT * FROM urunler WHERE urun_kategori_id=1");
while($kayit=mysql_fetch_array($sorgu)){ ?>
