			...
			<div id="sb-site">
				...
				<div class="wrap-content">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="section__inner">
										<h1 class="ui-title-page">Üye Ol</h1>
										<ol class="breadcrumb">
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8">
								<div class="checkout-top-line">Zaten Üyemisiniz ? <a class="checkout-top-line__link" href="login.php">Hemen Giriş Yapın...</a></div>
							</div>
							<!-- end col -->

							<div class="col-md-4">
								<div class="checkout-top-line">Fırsatlardan haberiniz var mı? <a class="checkout-top-line__link" href="pizzalar.php">İnceleyin..</a></div>
							</div>
							<!-- end col -->
						</div>
						<!-- end row -->
					...
					<div class="section_mod-f">
						<div class="container">
							<div class="row">
								<div class="col-md-8">
									<form method="post" action="regfinish.php" class="form-details">
										<section class="section-area">
											<h2 class="ui-title-inner ui-title-inner_mod-a">Yeni Üyelik </h2> <div class="section-bg_mod-c"><?php @session_start(); echo @$_SESSION['epostahata']; ?> </div>	
											
											<div class="row">
												<div class="col-md-6">
													<label class="ui-form-label">AD *</label>
													<input name="reg_Ad" class="form-control" type="text" required>
												</div>
												<div class="col-md-6">
													<label class="ui-form-label">SOYAD *</label>
													<input name="reg_Soyad" class="form-control" type="text" required>
												</div>
											</div>
                                            
											<label class="ui-form-label" >ŞİFRE *</label>
												<input id="reg_Sifre" name="reg_Sifre" type="password" class="form-control" type="text" required>
                                            <label class="ui-form-label">ŞİFRE TEKRAR *</label>
										...
										<textarea class="form-control" name="reg_Adres" rows="4" placeholder="Adresinizi Giriniz" required></textarea>
											
											<div class="row">
												<div class="col-md-6">
													<label class="ui-form-label">İLÇE / İL *</label>
													<input name="reg_ililce" class="form-control" type="text" placeholder="İlçe / İl">
												</div>
												<div class="col-md-6">
													<label class="ui-form-label">POSTA KODU </label>
													<input name="reg_Postakodu" class="form-control" type="text" placeholder="Posta Kodu">
												</div>
											</div>
											<div class="row">
												<div class="col-md-6">
													<label class="ui-form-label">EPOSTA ADRESİ *</label>
													<input name="reg_Eposta" class="form-control" type="text" required>
												</div>
                                           
												<div class="col-md-6">
													<label class="ui-form-label">TELEFON *</label>
													<input name="reg_Telefon" class="form-control" type="text" required>
												</div>
											</div>

											<input class="forms__check hidden" id="create-account" type="checkbox" name="create-account" value="" required>
											<label class="forms__label forms__label-check forms__label-check_mod-a" for="create-account">Üyeliği Onaylıyor musunuz?</label>
										</section>
										<!-- end section -->
...
reg_SifreTekrar.onkeyup = validatePassword;</script>
                                        <button style="width:100%" type="submit" name="KayitOl" class="form-payment__btn ui-btn ui-btn-primary btn-effect" id="KayitOlid">ÜYELİĞİ TAMAMLA</button>
								...
								<div class="col-md-4">
									<div class="section-table-order section-table-order_mod-a">
										<section class="section_mod-g">
											<h2 class="table-order__title ui-title-inner">Üyelik Avantajları</h2>
											<form class="form-payment">
												...
												<label class="form-payment__radio-label forms__label forms__label-radio" for="form-payment_bank">
													<span class="form-payment__item-title">Üyelerimize %15 İndirim</span>
													<span class="form-payment__description">Sistemize üye olan müşterilerimiz ilk siparişinde %15 indirim kazanacaklardır.</span>
												</label>
												...
												<label class="form-payment__radio-label forms__label forms__label-radio" for="form-payment_cheque">
													<span class="form-payment__item-title">Özel Fırsatlar</span>
                                                    <span class="form-payment__description">Müşterilerimiz özel kampanya ve fırsatlardan anında yararlanabileceklerdir.</span>
												</label>
												
												<a class="form-payment__btn ui-btn ui-btn-primary btn-effect" href="register.php">KAYDOL</a>
											</form>
										</section>
