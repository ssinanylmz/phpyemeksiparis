...
<?php 
@session_start();
if($_SESSION["uyeid"] && $_SESSION['onay']==0){
if(@$_SESSION['uyeid']){
			...
			<div id="sb-site">
				...
				<div class="wrap-content">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="section__inner">
										<h1 class="ui-title-page">Son Siparişlerim</h1>
										<ol class="breadcrumb">
											<li><a href="index.php">Anasayfa</a></li>
                                            	<li><a href="profilim.php">Profilim</a></li>
											<li class="active">Son Siparişlerim</li>
										</ol>
									</div>
									<!-- end section__inner -->
								</div>
					...
					<div class="container">
						<div class="row">
							<div class="col-md-8">
								<div class="checkout-top-line">Son Verdiğiniz siparişler aşağıda listelenmektedir. </a></div>
							</div>
							<!-- end col -->
								...
								<div class="col-md-8">
                                 ...
                                 <div class="table-container">
										<table class="table table-cart-order">
											...
											<tbody>
                                              <?php  $sorgu=mysql_query("SELECT * FROM siparisler WHERE siparis_uye_id='$uye_id'");
while($kayit=mysql_fetch_array($sorgu)){ ?>
												<tr>
												<td class=""><span class="table-cart-order__number"><?php echo $kayit["siparis_id"]; ?></span></td>
													<td class="">
														<span class="table-cart-order__name"><?php echo $kayit["siparis_musteri_adi"]." ".$kayit["siparis_musteri_soyadi"]; ?></span>
														<span class="table-cart-order__size"><b>Ayrıntılar:</b><?php echo $kayit["siparis_sepeti"]; ?></span>
													</td>
													<td class=""><span class="table-cart-order__price"><?php echo $kayit["siparis_fiyat"]; ?>.00₺</span></td>
													<td class=""><span class="table-cart-order__size"><?php echo $kayit["siparis_tarihi"]; ?></span></td>
	...
	<!-- end section-area -->
										...
										<section class="section_mod-g">
											...
											<form class="form-payment">
												...
												<a class="form-payment__btn ui-btn ui-btn-primary btn-effect" href="index.php">SİPARİŞ VER</a>
											</form>
										</section>
