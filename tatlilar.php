							...
							<div class="row">
								<div class="col-xs-12">
									<div class="section__inner">
										<h1 class="ui-title-page">Tatlı Menu</h1>
										<ol class="breadcrumb">
											<li><a href="index.php">Anasayfa</a></li>
											<li class="active">Tatlılar</li>
										</ol>
									</div>
									<!-- end section__inner -->
								</div>
						...
						<div class="row">
							<div class="col-xs-12">
								<div class="filter clearfix">
									<span class="filter__btn" data-toggle="collapse" data-target="#filter-categories"><i class="icon fa fa-bars"></i>TatlI ÇEŞİTLERİ</span>
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="pizza-builder__wrap-check">
										                          <?php  $sorgu=mysql_query("SELECT * FROM urunler WHERE urun_kategori_id=2");
while($kayit=mysql_fetch_array($sorgu)){ ?>
