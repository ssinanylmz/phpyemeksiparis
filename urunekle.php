...
<head>
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="section__inner">
										<h1 class="ui-title-page">Ürün Ekleme</h1>
										<ol class="breadcrumb">
							...
							<div class="row">
								...
								<div class="col-md-8">
                                   <div class="section-bg_mod-c"><?php @session_start(); echo @$_SESSION['sifrehata']; @$_SESSION['sifrehata']=""; ?> </div>	
									<form method="post" action="urunekleson.php" enctype="multipart/form-data" class="form-details">
										<section class="section-area">
                                            ...
                                            <label class="ui-form-label" >Urun Adi *</label>
												...
												<textarea  class="form-control" name="urun_aciklama" rows="4" placeholder="Açıklama Giriniz" required></textarea>
											...
											<select name="urun_kategori" class="selectpicker" data-style="ui-select">
												...
												<input name="urun_fiyat" class="form-control" type="text" required>
										   <div class="row">
												<div class="col-md-6">
    ...
    document.getElementById("fileToUploads").value = this.value;
                                                    ...
                                                    <button style="width:100%" type="submit" name="submit" class="form-payment__btn ui-btn ui-btn-primary btn-effect" id="submit">ÜRÜN EKLE</button>
