				...
				<div class="wrap-content">
							...
							<div class="row">
								<div class="col-xs-12">
									<div class="section__inner">
										<h1 class="ui-title-page">Ürün Listesi</h1>
										<ol class="breadcrumb">
					...
					<div class="section_mod-f">
						...
						<div class="container">
                                              ...
                                              <form method="get" action="urunlistesi.php" class="form-details">
										<section class="section-area">
											...
											<select id="kat_id" name="kat_id" class="selectpicker" data-style="ui-select">
												<option value="1">Pizza</option>
												<option value="2">Tatlı</option>
												<option value="3">İçeçek</option>
												<option value="4">Menü</option>	
											</select><br><br>

                                                    <button style="width:25%" type="submit"  class="form-payment__btn ui-btn ui-btn-primary btn-effect ">ÜRÜN LİSTELE</button>
								...
								<div class="col-md-8">
                                  ...
                                  <div class="table-container">
										<table class="table table-cart-order">
											...
											<tbody>
                                              <?php  $sorgu=mysql_query("SELECT * FROM urunler where urun_kategori_id='$kat_id' order by urun_id desc");
while($kayit=mysql_fetch_array($sorgu)){ ?>
												<tr>
												<td class=""><span class="table-cart-order__number"><?php echo $kayit["urun_id"]; ?></span></td>
                                               <td class="">
                                               <span class="no-br">
                                               <div class="sinifim"> 
                                              <img class="table-cart-order__img img-responsive" src="<?php if($kayit["urun_pic"]){echo $kayit["urun_pic"];}else{ ?>images/profilepic.png<?php } ?>" height="109" width="109" alt="Foto"/></div>
                                               </span>
                                               </td>
													
													<td class="">
														<span class="table-cart-order__name"><?php echo $kayit["urun_adi"]; ?></span>	
                                                        <span class="table-cart-order__size"><b>Açıklama:</b><?php echo $kayit["urun_aciklama"]; ?></span>
                                                      
													</td>
													
													
														<td class=""><span class="table-cart-order__price"><a href="#"><?php echo $kayit["urun_fiyat"]; ?>.00₺</a></span></td>
                                                        		<td class=""><span class="table-cart-order__size"><a href="urunsil.php?urun_id=<?php echo $kayit["urun_id"];  ?>"><img width="50px" height="50px" src="images/Delete.png"/></a></span></td>
                                                                      		<td class=""><span class="table-cart-order__size"><a href="urunguncelle.php?urun_id=<?php echo $kayit["urun_id"];  ?>"><img width="50px" height="50px" src="images/document_edit.png"/></a></span></td>
												</tr>
												<?php } ?>
											</tbody>
										</table>
