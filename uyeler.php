							...
							<div class="row">
								<div class="col-xs-12">
									<div class="section__inner">
										<h1 class="ui-title-page">Üyeler</h1>
										<ol class="breadcrumb">
								...
								<div class="col-md-8">
                                 ...
                                 <div class="table-container">
										<table class="table table-cart-order">
											...
											<tbody>
                                              <?php  $sorgu=mysql_query("SELECT * FROM uyeler where uye_onay=0 order by uye_id desc");
while($kayit=mysql_fetch_array($sorgu)){ ?>
												<tr>
                                               ...
                                               <img class="table-cart-order__img img-responsive" src="<?php if($kayit["uye_pf"]){echo $kayit["uye_pf"];}else{ ?>images/profilepic.png<?php } ?>" height="109" width="109" alt="Foto"/></div>
													...
													<td class=""><span class="table-cart-order__size"><a href="adminyap.php?uye_id=<?php echo $kayit["uye_id"];  ?>"><img width="50px" height="50px" src="images/tick.png"/></a></span></td>
